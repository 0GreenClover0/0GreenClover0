...
I'm a passionate and versatile developer who thrives at the intersection of **creativity and low-level systems**. I take pride in understanding how things work under the hood - and pushing them further.
...
- **DirectX 11 and C++23** - Built a custom engine from scratch.
...
- **Unity (C#)** - 8+ years, gameplay programming, multiplayer, systems design, optimization (PC, standalone VR).
  - Commercially: [Brace UP VR](https://blog.vhsoft.io/braceup-vr/) + and other proprietary client work focused on trainings and simulations
